...
def fetch_classes(db, args):
    ...
    try:
        ...
        # Fetch courses
        courses_list = []
        tqdm_categories = tqdm.tqdm(
            categories, leave=False, desc="Processing Categories"
        )
        ...
        for category in tqdm_categories:
            ...
            semesters = (
                ...
                if args.fast
                    ...
                    common.All_SEMESTERS, leave=False, desc="Processing Semesters"
                )
            )
            ...
            for semester in semesters:
                ...
                try:
                    ...
                    for course in tqdm.tqdm(
                        courses, leave=False, desc="Processing Courses"
                    ):
                    ...
                    logging.error(
                        f"Error processing category {category}, semester {semester}: {e}"
                    )
